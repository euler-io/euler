...
public class UpdateIndexMappingInitializableConfigConverter implements ContextConfigConverter {
    ...
    public ConfigContext convert(ConfigValue value, ConfigContext ctx, TypesConfigConverter typesConfigConverter) {
        ...
        hooks.registerInitializable(new UpdateIndexMappingInitializable(client, config));
        return ctx;
    }
    ...
    protected Config getDefaultConfig() {
        URL resource = getClass().getClassLoader().getResource("updateindex.conf");
